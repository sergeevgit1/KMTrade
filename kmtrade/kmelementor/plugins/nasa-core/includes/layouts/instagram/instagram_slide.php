...
echo '<div class="' . esc_attr($ulclass) . '" data-margin="0" data-margin-small="0" data-margin-medium="0" data-columns="' . $photos . '" data-columns-small="' . $photos_mobile . '" data-columns-tablet="' . $photos_tablet . '" data-autoplay="false" data-loop="false" data-height-auto="false" data-dot="false" data-disable-nav="false" data-switch-tablet="' . nasa_switch_tablet() . '" data-switch-desktop="' . nasa_switch_desktop() . '">';
