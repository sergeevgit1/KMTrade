...
<div class="nasa-relative nasa-slide-style-blogs nasa-slider-wrap">
    <?php if ($arrows == 1) : ?>
        ...
        <div
            ...
            while ($recentPosts->have_posts()) :
                ...
                if ($date_enable == 'yes') :
                    ...
                    $date_post = get_the_time('M d, Y', $postId);
                endif;
                                ...
                                <div class="blog-image img_left">
                                    <div class="blog-image-attachment" style="overflow:hidden;">
                                        ...
                                        if (has_post_thumbnail()):
                                            the_post_thumbnail('368x230', array(
                            ...
                            <?php if ($date_author == 'top') : ?>
                                <div class="nasa-post-date-author-wrap">
                                    <?php if ($date_enable == 'yes') : ?>
                                        <a href="<?php echo esc_url($link_date); ?>" title="<?php echo esc_html__('Posts at ', 'nasa-core') . esc_attr($date_post); ?>" class="nasa-post-date-author-link nasa-date-post">
    ...
    <?php if ($page_blogs == 'yes') : ?>
        <div class="row">
            <div class="large-12 columns text-center margin-bottom-30">
                <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" title="<?php echo esc_html__('All blogs', 'nasa-core'); ?>" class="nasa-blog-btn nasa-view-more">
