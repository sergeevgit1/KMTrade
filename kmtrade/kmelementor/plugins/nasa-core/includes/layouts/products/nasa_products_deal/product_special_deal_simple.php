...
<?php if (isset($title) && $title != '') : ?>
    <h4 class="nasa-title nasa-heading-title margin-bottom-20">
            ...
            <?php while ($specials->have_posts()) :
                ...
                <div class="nasa-special-deal-item">
                    <div class="wow fadeInUp product-item-deal-simple<?php echo $nasa_animated_products ? ' ' . esc_attr($nasa_animated_products) : ''; ?>" data-wow-duration="1s" data-wow-delay="0ms">
                        ...
                        <div class="product-special-deals text-center">
                            
                            <!-- Image product -->
                            <div class="product-img margin-bottom-10">
