...
<div class="row">
    <div class="large-9 columns margin-top-5 rtl-right">
        <div class="nasa-main-special nasa-slider-wrap">
            <div class="nasa-main-top">
                <h3 class="nasa-sc-title"><?php echo $title; ?></h3>
                                    ...
                                    <div class="row product-special-deals">
                                        ...
                                        <div class="large-7 medium-7 columns rtl-left">
                                            <div class="product-deal-special-wrap-info mobile-margin-top-30">
                                                 ...
                                                 */
                                                $buttons = '';
                                                $nasa_function = defined('NASA_THEME_PREFIX') && function_exists(NASA_THEME_PREFIX . '_add_to_cart_btn') ? NASA_THEME_PREFIX . '_add_to_cart_btn' : false;

                                                if ($nasa_function) :
                                                    $buttons = $nasa_function(false);
                                                ?>
                                                    <div class="product-deal-special-buttons nasa-product-grid">
    ...
    <div class="large-3 columns hide-for-small rtl-left">
        <div
            class="nasa-slider-deal-vertical-extra-switcher nasa-slider-deal-vertical-extra-<?php echo esc_attr($id_sc); ?> wow fadeInUp<?php echo $nasa_animated_products ? ' ' . esc_attr($nasa_animated_products) : ''; ?> nasa-nav-4-items"
            data-wow-duration="1s"
            data-wow-delay="0ms"
            data-count="<?php echo count($vertical_product); ?>">
