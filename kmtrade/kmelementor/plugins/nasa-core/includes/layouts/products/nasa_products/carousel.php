...
$pos_nav = (!isset($pos_nav) || $pos_nav != 'left') ? 'side' : 'left';
...
<?php else :
    ...
    <div class="nasa-relative nasa-slide-style-product-carousel nasa-warp-slide-nav-top<?php echo ' title-align-' . $title_align; ?>">
        ...
        <div
            class="slider products-group nasa-slider owl-carousel products grid nasa-slider-grid<?php echo $style_row > 1 ? ' nasa-slide-double-row' : ''; ?>"
            data-margin="<?php echo esc_attr($data_margin); ?>"
            data-margin-small="0"
            data-margin-medium="0"
            data-columns="<?php echo esc_attr($columns_number); ?>"
            ...
            data-switch-tablet="<?php echo nasa_switch_tablet(); ?>"
            data-switch-desktop="<?php echo nasa_switch_desktop(); ?>"
            data-disable-nav="<?php echo $arrows == 1 ? 'false' : 'true'; ?>">
            <?php
            $k = 0;
