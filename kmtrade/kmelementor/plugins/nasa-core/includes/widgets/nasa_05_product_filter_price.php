...
if (class_exists('WC_Widget')) {
    ...
    add_action('widgets_init', 'nasa_product_filter_price_widget');
    function nasa_product_filter_price_widget() {
        register_widget('Nasa_WC_Widget_Price_Filter');
    }
     ...
     * @extends  WC_Widget
     */
    class Nasa_WC_Widget_Price_Filter extends WC_Widget {
        ...
        public function __construct() {
            ...
            $this->widget_description = esc_html__('Shows a price filter slider in a widget which lets you narrow down the list of shown products when viewing product categories.', 'nasa-core');
            $this->widget_id = 'nasa_woocommerce_price_filter';
            $this->widget_name = esc_html__('Nasa Product Price Filter', 'nasa-core');
            $this->settings = array(
                'title' => array(
                    'type' => 'text',
                ...
                'btn_filter' => array(
                    'type' => 'checkbox',
                    'std' => 0,
                    'label' => esc_html__('Enable Button filter', 'nasa-core')
                ),
            );
        ...
        public function widget($args, $instance) {
            ...
            echo nasa_get_content_widget_price($args, $instance);
