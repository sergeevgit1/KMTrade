...
function nasa_sc_carousel($atts, $content = null) {
    ...
    <div class="<?php echo esc_attr($class_wrap); ?>">
        ...
        <div class="nasa-sc-carousel-warper">
            <div
                class="nasa-sc-carousel owl-carousel<?php echo $nav_type != '' ? ' ' . esc_attr($nav_type) : ''; ?>"
                data-margin="<?php echo esc_attr($data_margin); ?>"
                data-margin-small="<?php echo esc_attr($data_margin); ?>"
                data-margin-medium="<?php echo esc_attr($data_margin); ?>"
...
function nasa_register_slider(){
    $slider_params = array(
        ...
        "params" => array(
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__("Item Margin (px)", 'nasa-core'),
            ...
            array(
                ...
                "description" => esc_html__('You only use bullets or arrows for navigation. If disable bullets. You can select arrow navigation at bellow.', 'nasa-core')
            ),
            array(
                "type" => "dropdown",
                ...
                "value" => array(
                    esc_html__('Out-side', 'nasa-core') => '',
                    esc_html__('In-side', 'nasa-core') => 'inside'
                ),
                "description" => esc_html__('Select bullets position.', 'nasa-core')
            ),
            array(
                "type" => "dropdown",
