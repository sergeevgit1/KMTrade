...
<head>
    ...
    /* Стили для основного меню  повышенной специфичностью */
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <a href="<?php echo esc_url(home_url('/quick-order/')); ?>" 
                       class="bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-hover transition-colors inline-block">
                        Быстрый заказ
                    </a>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="flex-1 flex items-center justify-between relative">
                    ...
                    <a href="<?php echo esc_url(home_url('/wp/my-order/')); ?>" 
                       class="order-button hidden md:flex items-center space-x-2 bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-hover transition-colors">
