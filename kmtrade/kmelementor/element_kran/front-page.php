...
<main>
    ...
    <section class="container mx-auto px-4 py-8">
        <div class="bg-[#080808] text-white py-16 px-8 rounded-2xl relative overflow-hidden">
            <div class="max-w-4xl">
                <div class="w-[60%]">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6 text-left">Каталог запчастей для башенных кранов</h1>
                    <p class="text-xl mb-8 text-left">В нашем каталоге более 1000 наименований запчастей для башенных кранов ведущих производителей: Potain, Liebherr, Zoomlion и Comansa</p>
                    <button onclick="openOrderModal()" 
                            class="bg-white text-[#080808] px-10 py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors text-lg">
                        Быстрый заказ
                    </button>
                </div>
            </div>
            <div class="absolute right-0 top-0 h-full w-[40%]">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        foreach ($categories as $category) {
            $all_items[] = array(
                ...
                'link' => add_query_arg('product_cat', $category->slug, home_url('/wp/parts/')),
                'type' => 'category'
            );
        }
        ...
        foreach ($manufacturers as $manufacturer) {
            ...
            $manufacturer_url = add_query_arg('manufacturer', strtolower($manufacturer), home_url('/wp/parts/'));
