			...
			<div class="small-12 columns">
				...
				<div class="site-content">
					...
					<header class="entry-header">
					 ...
					 <div class="nav-links">
					    <?php previous_image_link( false, '<span class="previous-image">' . __( 'Previous ', 'the-hanger' ) . '</span>' ); ?>
					    <?php next_image_link( false, '<span class="next-image">' . __( 'Next ', 'the-hanger' ) . '</span>' ); ?>
					</div><!-- .nav-links -->
