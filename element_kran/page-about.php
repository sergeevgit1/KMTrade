...
<div class="container mx-auto px-4 py-8">
    <!-- Hero секция -->
    <section class="relative mb-16 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl overflow-hidden">
        ...
        <div class="relative px-4 py-24 md:py-32">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    Надежный партнер в поставке запчастей для башенных кранов
                </h1>
                <p class="text-xl md:text-2xl text-white/90 mb-8 font-light">
                    С 2010 года мы обеспечиваем бесперебойную работу строительной техники по всей России
                </p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
                    <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-lg">
                        ...
                        <div class="text-white/90 text-sm uppercase tracking-wider">лет на рынке</div>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="md:flex">
                <div class="md:w-1/2 p-8 md:p-12">
                    <div class="inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-6">
                        О нас
                    </div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Профессионализм, проверенный временем</h2>
                    ...
                    <div class="mt-8 flex gap-4">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/cert1.png" 
                             alt="Сертификат" 
                             class="h-16 w-auto">
                        <!-- ... другие сертификаты ... -->
                    </div>
                ...
                <div class="md:w-1/2 relative">
                    ...
                    <div class="absolute -bottom-6 -left-6 w-24 h-24 bg-primary rounded-full hidden md:block"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mb-24">
        <div class="text-center mb-12">
            <div class="inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-4">
                Преимущества
            </div>
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Почему выбирают нас</h2>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-2xl shadow-lg transform hover:-translate-y-1 transition-transform duration-300">
    ...
    <section class="mb-24">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Реализованные проекты</h2>
        </div>
    ...
    <section class="mb-24">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Официальный представитель</h2>
        </div>
    ...
    <section class="mb-24">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Наши специалисты</h2>
        </div>
    ...
    <section id="contacts" class="mb-24">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Свяжитесь с нами</h2>
        </div>
