...
<header class="bg-white">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <?php 
                        ...
                        if ($custom_logo_id) {
                            ...
                            <img src="<?php echo esc_url($logo[0]); ?>" 
                                 ...
                                 class="w-auto h-8 max-h-[32px] object-contain">
                        <?php } else { ?>
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 hover:text-gray-700 transition-colors">
                            <span class="text-brand-orange">КМ</span>-Трейд
                        </h1>
    ...
    <!-- Обертка для sticky-позиционирования -->
                        ...
                        <nav class="flex flex-1">
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="flex items-center">
                                    <?php for ($i = 1; $i <= 5; $i++) : ?>
                                        <a href="<?php echo esc_url(get_theme_mod("catalog_menu_item{$i}_url", '#')); ?>" 
                                           class="group relative px-5 py-3.5 text-white hover:bg-brand-orange-dark transition-colors">
                                            <span class="font-medium whitespace-nowrap text-sm uppercase">
                                                <?php echo esc_html(get_theme_mod("catalog_menu_item{$i}_title", '')); ?>
                                            </span>
                                        </a>
                                    <?php endfor; ?>
                                </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <a href="<?php echo esc_url(get_theme_mod('quick_order_url', '#')); ?>" 
                                       class="inline-flex items-center px-6 py-2 my-2 bg-white text-brand-orange rounded-lg hover:bg-gray-50 transition-colors">
                                        <span class="font-medium whitespace-nowrap text-sm uppercase">
                                            <?php echo esc_html(get_theme_mod('quick_order_text', 'Быстрый заказ')); ?>
                                        </span>
                                    </a>
                                    <a href="<?php echo esc_url(get_theme_mod('cart_url', '#')); ?>"
                                       class="flex items-center px-5 py-3.5 text-white hover:bg-brand-orange-dark transition-colors rounded-r-lg bg-brand-orange-dark/20">
        ...
        <div class="container mx-auto px-4">
            <div class="bg-brand-orange rounded-lg">
                <div class="flex items-stretch">
                    ...
                    <div class="relative">
                        <a href="#"
                           class="flex h-full items-center gap-2 bg-brand-orange-dark text-white px-6 py-3.5 hover:bg-brand-orange-dark/90 transition-colors rounded-l-lg">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                      d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                    ...
                    <nav class="flex flex-1">
                        <div class="flex items-center justify-between w-full">
                            <!-- Левая группа -->
                            <div class="flex items-center">
                                <a href="#" class="group relative px-5 py-3.5 text-white hover:bg-brand-orange-dark transition-colors">
                                    <span class="font-medium whitespace-nowrap text-sm uppercase">
                                        Механизмы подъема
                                    </span>
                                </a>
                            ...
                            <!-- Корзина -->
                            <div class="flex items-center gap-4">
                                <a href="#" class="inline-flex items-center px-6 py-2 my-2 bg-white text-brand-orange rounded-lg hover:bg-gray-50 transition-colors">
                                    <span class="font-medium whitespace-nowrap text-sm uppercase">
                                        Быстрый заказ
                                    </span>
                                </a>
...
<main>
    <?php // Здесь будет основной контент ?>
</main>
</body> 